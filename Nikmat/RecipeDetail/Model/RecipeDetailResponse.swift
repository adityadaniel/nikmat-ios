...
struct RecipeDetail {
  ...
  func convertToRecipe(withKey key: String) -> Recipe {
    Recipe(title: title, thumb: thumb ?? "", times: times, key: key, serving: servings, difficulty: difficulty)
  }
...
extension RecipeVideo: Decodable {}
